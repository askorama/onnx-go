...
func init() {
	testbackend.Register("Unsqueeze", "TestUnsqueezeTwoAxes", NewTestUnsqueezeTwoAxes)
}
...
// NewTestUnsqueezeTwoAxes version: 5.
func NewTestUnsqueezeTwoAxes() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Unsqueeze",
		Title:  "TestUnsqueezeTwoAxes",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0002e4100)(name:"axes" type:INTS ints:1 ints:4 )
		   }
		   ,
		   },
