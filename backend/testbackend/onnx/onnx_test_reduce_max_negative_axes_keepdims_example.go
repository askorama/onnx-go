...
func init() {
	testbackend.Register("ReduceMax", "TestReduceMaxNegativeAxesKeepdimsExample", NewTestReduceMaxNegativeAxesKeepdimsExample)
}
...
// NewTestReduceMaxNegativeAxesKeepdimsExample version: 6.
func NewTestReduceMaxNegativeAxesKeepdimsExample() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ReduceMax",
		Title:  "TestReduceMaxNegativeAxesKeepdimsExample",
