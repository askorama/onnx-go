...
func init() {
	testbackend.Register("Unsqueeze", "TestUnsqueezeThreeAxes", NewTestUnsqueezeThreeAxes)
}
...
// NewTestUnsqueezeThreeAxes version: 5.
func NewTestUnsqueezeThreeAxes() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Unsqueeze",
		Title:  "TestUnsqueezeThreeAxes",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217d00)(name:"axes" type:INTS ints:2 ints:4 ints:5 )
		   }
		   ,
		   },
