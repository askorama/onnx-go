...
func init() {
	testbackend.Register("ReduceLogSumExp", "TestReduceLogSumExpNegativeAxesKeepdimsRandom", NewTestReduceLogSumExpNegativeAxesKeepdimsRandom)
}
...
// NewTestReduceLogSumExpNegativeAxesKeepdimsRandom version: 6.
func NewTestReduceLogSumExpNegativeAxesKeepdimsRandom() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ReduceLogSumExp",
		Title:  "TestReduceLogSumExpNegativeAxesKeepdimsRandom",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000128c40)(name:"axes" type:INTS ints:-2 ),
		    (*ir.AttributeProto)(0xc000128d20)(name:"keepdims" type:INT i:1 )
		   }
		   ,
		   },
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				...
				tensor.WithBacking([]float32{2.3478897, 4.3364186, -0.6847583, 7.8427505, 9.304855, 0.63099027}),
			),
		},
	}
}
