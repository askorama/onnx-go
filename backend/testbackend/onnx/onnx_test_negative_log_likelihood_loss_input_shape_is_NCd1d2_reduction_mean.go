...
func init() {
	testbackend.Register("NegativeLogLikelihoodLoss", "TestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionMean", NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionMean)
}
...
// NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionMean version: 6.
func NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionMean() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "NegativeLogLikelihoodLoss",
		Title:  "TestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionMean",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000216b00)(name:"reduction" type:STRING s:"mean" )
		   }
		   ,
		   },
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(1),
				tensor.WithBacking([]float32{-0.5448008}),
			),
		},
	}
}
