...
func init() {
	testbackend.Register("Flatten", "TestFlattenNegativeAxis4", NewTestFlattenNegativeAxis4)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:              "test_flatten_negative_axis4",
        Initializer:       nil,
                        ...
                        TensorType: &ir.TypeProto_Tensor{
                            ...
                            Shape:    &ir.TensorShapeProto{
                                Dim: {
                                    ...
                                    &ir.TensorShapeProto_Dimension{
                                        Value:      &ir.TensorShapeProto_Dimension_DimValue{DimValue:120},
                                        Denotation: "",
                                    },
                                },
                            },
...
// NewTestFlattenNegativeAxis4 version: 6.
func NewTestFlattenNegativeAxis4() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Flatten",
		Title:  "TestFlattenNegativeAxis4",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217700)(name:"axis" type:INT i:-4 )
		   }
		   ,
		   },
