...
func TestNewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionSum(t *testing.T) {
	mytest := NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionSum()
