...
func init() {
	testbackend.Register("Flatten", "TestFlattenNegativeAxis1", NewTestFlattenNegativeAxis1)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:              "test_flatten_negative_axis1",
        Initializer:       nil,
