...
func TestNewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionMean(t *testing.T) {
	mytest := NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2ReductionMean()
