...
func init() {
	testbackend.Register("Dropout", "TestDropoutRandomOld", NewTestDropoutRandomOld)
}
...
// NewTestDropoutRandomOld version: 6.
func NewTestDropoutRandomOld() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Dropout",
		Title:  "TestDropoutRandomOld",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217800)(name:"ratio" type:FLOAT f:0.2 )
		   }
		   ,
		   },
