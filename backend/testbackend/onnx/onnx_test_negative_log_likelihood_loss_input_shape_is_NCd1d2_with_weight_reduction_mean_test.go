...
func TestNewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionMean(t *testing.T) {
	mytest := NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionMean()
