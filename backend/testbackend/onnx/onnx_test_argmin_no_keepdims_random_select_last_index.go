...
func init() {
	testbackend.Register("ArgMin", "TestArgminNoKeepdimsRandomSelectLastIndex", NewTestArgminNoKeepdimsRandomSelectLastIndex)
}
...
// NewTestArgminNoKeepdimsRandomSelectLastIndex version: 6.
func NewTestArgminNoKeepdimsRandomSelectLastIndex() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ArgMin",
		Title:  "TestArgminNoKeepdimsRandomSelectLastIndex",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217200)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
