...
func init() {
	testbackend.Register("Reshape", "TestReshapeReorderedLastDims", NewTestReshapeReorderedLastDims)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:              "test_reshape_reordered_last_dims",
        Initializer:       nil,
...
// NewTestReshapeReorderedLastDims version: 6.
func NewTestReshapeReorderedLastDims() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Reshape",
		Title:  "TestReshapeReorderedLastDims",
		...
		*/
		...
		Input: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(3),
				tensor.WithBacking([]int64{2, 4, 3}),
			),
		},
