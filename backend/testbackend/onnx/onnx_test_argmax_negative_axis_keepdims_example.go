...
func init() {
	testbackend.Register("ArgMax", "TestArgmaxNegativeAxisKeepdimsExample", NewTestArgmaxNegativeAxisKeepdimsExample)
}
...
// NewTestArgmaxNegativeAxisKeepdimsExample version: 6.
func NewTestArgmaxNegativeAxisKeepdimsExample() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ArgMax",
		Title:  "TestArgmaxNegativeAxisKeepdimsExample",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc00039e400)(name:"axis" type:INT i:-1 ),
		    (*ir.AttributeProto)(0xc00039e500)(name:"keepdims" type:INT i:1 )
		   }
		   ,
		   },
