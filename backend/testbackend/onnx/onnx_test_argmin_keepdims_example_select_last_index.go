...
func init() {
	testbackend.Register("ArgMin", "TestArgminKeepdimsExampleSelectLastIndex", NewTestArgminKeepdimsExampleSelectLastIndex)
}
...
// NewTestArgminKeepdimsExampleSelectLastIndex version: 6.
func NewTestArgminKeepdimsExampleSelectLastIndex() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ArgMin",
		Title:  "TestArgminKeepdimsExampleSelectLastIndex",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217600)(name:"axis" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc000217700)(name:"keepdims" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc000217800)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
