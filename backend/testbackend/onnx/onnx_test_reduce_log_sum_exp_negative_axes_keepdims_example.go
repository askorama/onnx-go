...
func init() {
	testbackend.Register("ReduceLogSumExp", "TestReduceLogSumExpNegativeAxesKeepdimsExample", NewTestReduceLogSumExpNegativeAxesKeepdimsExample)
}
...
// NewTestReduceLogSumExpNegativeAxesKeepdimsExample version: 6.
func NewTestReduceLogSumExpNegativeAxesKeepdimsExample() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ReduceLogSumExp",
		Title:  "TestReduceLogSumExpNegativeAxesKeepdimsExample",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000128a80)(name:"axes" type:INTS ints:-2 ),
		    (*ir.AttributeProto)(0xc000128b60)(name:"keepdims" type:INT i:1 )
		   }
		   ,
		   },
