	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &pb.NodeProto{
		    ...
		    (*pb.AttributeProto)(0xc00014ae00)(name:"ceil_mode" type:INT i:1 ),
		    (*pb.AttributeProto)(0xc00014af00)(name:"kernel_shape" type:INTS ints:3 ints:3 ),
		    (*pb.AttributeProto)(0xc00014b000)(name:"strides" type:INTS ints:2 ints:2 )
		   }
		   ,
		   },
