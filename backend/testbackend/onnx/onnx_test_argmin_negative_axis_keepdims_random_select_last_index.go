...
func init() {
	testbackend.Register("ArgMin", "TestArgminNegativeAxisKeepdimsRandomSelectLastIndex", NewTestArgminNegativeAxisKeepdimsRandomSelectLastIndex)
}
...
// NewTestArgminNegativeAxisKeepdimsRandomSelectLastIndex version: 6.
func NewTestArgminNegativeAxisKeepdimsRandomSelectLastIndex() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ArgMin",
		Title:  "TestArgminNegativeAxisKeepdimsRandomSelectLastIndex",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217a00)(name:"axis" type:INT i:-1 ),
		    (*ir.AttributeProto)(0xc000217b00)(name:"keepdims" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc000217c00)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
