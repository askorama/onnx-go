...
func init() {
	testbackend.Register("Concat", "TestConcat2dAxisNegative1", NewTestConcat2dAxisNegative1)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:              "test_concat_2d_axis_negative_1",
        Initializer:       nil,
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217300)(name:"axis" type:INT i:-1 )
		   }
		   ,
		   },
