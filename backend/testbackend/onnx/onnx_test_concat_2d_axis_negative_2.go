...
func init() {
	testbackend.Register("Concat", "TestConcat2dAxisNegative2", NewTestConcat2dAxisNegative2)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:        "test_concat_2d_axis_negative_2",
        Initializer: nil,
        DocString:   "",
        Input:       {
            &ir.ValueInfoProto{
...
// NewTestConcat2dAxisNegative2 version: 6.
func NewTestConcat2dAxisNegative2() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Concat",
		Title:  "TestConcat2dAxisNegative2",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0001767e0)(name:"axis" type:INT i:-2 )
		   }
		   ,
		   },
