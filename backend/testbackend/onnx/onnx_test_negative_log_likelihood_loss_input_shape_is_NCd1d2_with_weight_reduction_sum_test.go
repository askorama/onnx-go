...
func TestNewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionSum(t *testing.T) {
	mytest := NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionSum()
