...
func init() {
	testbackend.Register("Flatten", "TestFlattenNegativeAxis3", NewTestFlattenNegativeAxis3)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:        "test_flatten_negative_axis3",
        Initializer: nil,
        DocString:   "",
        Input:       {
            &ir.ValueInfoProto{
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc00035a0e0)(name:"axis" type:INT i:-3 )
		   }
		   ,
		   },
