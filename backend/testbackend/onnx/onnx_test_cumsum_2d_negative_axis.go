...
func init() {
	testbackend.Register("CumSum", "TestCumsum2dNegativeAxis", NewTestCumsum2dNegativeAxis)
}
...
// NewTestCumsum2dNegativeAxis version: 6.
func NewTestCumsum2dNegativeAxis() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "CumSum",
		Title:  "TestCumsum2dNegativeAxis",
