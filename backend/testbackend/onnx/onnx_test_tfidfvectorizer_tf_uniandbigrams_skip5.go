	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &pb.NodeProto{
		    ...
		    (*pb.AttributeProto)(0xc0002c8700)(name:"max_gram_length" type:INT i:2 ),
		    (*pb.AttributeProto)(0xc0002c8800)(name:"max_skip_count" type:INT i:5 ),
		    (*pb.AttributeProto)(0xc0002c8900)(name:"min_gram_length" type:INT i:1 ),
		    (*pb.AttributeProto)(0xc0002c8a00)(name:"mode" type:STRING s:"TF" ),
		    (*pb.AttributeProto)(0xc0002c8b00)(name:"ngram_counts" type:INTS ints:0 ints:4 ),
		    (*pb.AttributeProto)(0xc0002c8c00)(name:"ngram_indexes" type:INTS ints:0 ints:1 ints:2 ints:3 ints:4 ints:5 ints:6 ),
		    (*pb.AttributeProto)(0xc0002c8d00)(name:"pool_int64s" type:INTS ints:2 ints:3 ints:5 ints:4 ints:5 ints:6 ints:7 ints:8 ints:6 ints:7 )
		   }
		   ,
		   },
