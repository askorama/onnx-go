	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &pb.NodeProto{
		    ...
		    (*pb.AttributeProto)(0xc00010a800)(name:"max_gram_length" type:INT i:2 ),
		    (*pb.AttributeProto)(0xc00010a900)(name:"max_skip_count" type:INT i:5 ),
		    (*pb.AttributeProto)(0xc00010aa00)(name:"min_gram_length" type:INT i:1 ),
		    (*pb.AttributeProto)(0xc00010ab00)(name:"mode" type:STRING s:"TF" ),
		    (*pb.AttributeProto)(0xc00010ac00)(name:"ngram_counts" type:INTS ints:0 ints:4 ),
		    (*pb.AttributeProto)(0xc00010ad00)(name:"ngram_indexes" type:INTS ints:0 ints:1 ints:2 ints:3 ints:4 ints:5 ints:6 ),
		    (*pb.AttributeProto)(0xc00010ae00)(name:"pool_int64s" type:INTS ints:2 ints:3 ints:5 ints:4 ints:5 ints:6 ints:7 ints:8 ints:6 ints:7 )
		   }
		   ,
		   },
