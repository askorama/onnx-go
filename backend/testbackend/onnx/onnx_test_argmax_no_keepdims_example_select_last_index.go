...
func init() {
	testbackend.Register("ArgMax", "TestArgmaxNoKeepdimsExampleSelectLastIndex", NewTestArgmaxNoKeepdimsExampleSelectLastIndex)
}
...
// NewTestArgmaxNoKeepdimsExampleSelectLastIndex version: 6.
func NewTestArgmaxNoKeepdimsExampleSelectLastIndex() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ArgMax",
		Title:  "TestArgmaxNoKeepdimsExampleSelectLastIndex",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217d00)(name:"axis" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc000217e00)(name:"keepdims" type:INT ),
		    (*ir.AttributeProto)(0xc000217f00)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
