...
func init() {
	testbackend.Register("BatchNormalization", "TestBatchnormEpsilonOld", NewTestBatchnormEpsilonOld)
}
...
// NewTestBatchnormEpsilonOld version: 6.
func NewTestBatchnormEpsilonOld() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "BatchNormalization",
		Title:  "TestBatchnormEpsilonOld",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0002d6400)(name:"epsilon" type:FLOAT f:0.01 )
		   }
		   ,
		   },
