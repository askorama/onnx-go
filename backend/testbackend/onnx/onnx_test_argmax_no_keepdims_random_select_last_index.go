...
func init() {
	testbackend.Register("ArgMax", "TestArgmaxNoKeepdimsRandomSelectLastIndex", NewTestArgmaxNoKeepdimsRandomSelectLastIndex)
}
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000176d20)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
