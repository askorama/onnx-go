...
&ir.ModelProto{
    IrVersion:   3,
    OpsetImport: {
        &ir.OperatorSetIdProto{Domain:"", Version:6},
    },
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000176460)(name:"axes" type:INTS ints:2 ints:1 ),
		    (*ir.AttributeProto)(0xc000176540)(name:"keepdims" type:INT )
		   }
		   ,
		   },
