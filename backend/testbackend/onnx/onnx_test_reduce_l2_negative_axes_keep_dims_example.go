...
func init() {
	testbackend.Register("ReduceL2", "TestReduceL2NegativeAxesKeepDimsExample", NewTestReduceL2NegativeAxesKeepDimsExample)
}
...
// NewTestReduceL2NegativeAxesKeepDimsExample version: 6.
func NewTestReduceL2NegativeAxesKeepDimsExample() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ReduceL2",
		Title:  "TestReduceL2NegativeAxesKeepDimsExample",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217c00)(name:"axes" type:INTS ints:-1 ),
		    (*ir.AttributeProto)(0xc000217d00)(name:"keepdims" type:INT i:1 )
		   }
		   ,
		   },
