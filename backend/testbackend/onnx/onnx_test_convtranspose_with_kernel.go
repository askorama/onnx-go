	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &pb.NodeProto{
		    ...
		    (*pb.AttributeProto)(0xc000140a00)(name:"kernel_shape" type:INTS ints:3 ints:3 ),
		    (*pb.AttributeProto)(0xc000140b00)(name:"output_padding" type:INTS ints:1 ints:1 ),
		    (*pb.AttributeProto)(0xc000140c00)(name:"output_shape" type:INTS ints:10 ints:8 ),
		    (*pb.AttributeProto)(0xc000140d00)(name:"strides" type:INTS ints:3 ints:2 )
		   }
		   ,
		   },
