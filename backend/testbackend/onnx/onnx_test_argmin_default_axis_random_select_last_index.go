...
func init() {
	testbackend.Register("ArgMin", "TestArgminDefaultAxisRandomSelectLastIndex", NewTestArgminDefaultAxisRandomSelectLastIndex)
}
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000128620)(name:"keepdims" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc000128700)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
