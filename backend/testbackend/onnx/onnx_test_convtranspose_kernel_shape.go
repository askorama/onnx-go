	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000314000)(name:"kernel_shape" type:INTS ints:3 ints:3 ),
		    (*ir.AttributeProto)(0xc000314100)(name:"output_padding" type:INTS ints:1 ints:1 ),
		    (*ir.AttributeProto)(0xc000314200)(name:"output_shape" type:INTS ints:10 ints:8 ),
		    (*ir.AttributeProto)(0xc000314300)(name:"strides" type:INTS ints:3 ints:2 )
		   }
		   ,
		   },
