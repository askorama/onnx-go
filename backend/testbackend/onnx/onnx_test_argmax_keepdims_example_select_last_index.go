...
func init() {
	testbackend.Register("ArgMax", "TestArgmaxKeepdimsExampleSelectLastIndex", NewTestArgmaxKeepdimsExampleSelectLastIndex)
}
...
// NewTestArgmaxKeepdimsExampleSelectLastIndex version: 6.
func NewTestArgmaxKeepdimsExampleSelectLastIndex() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ArgMax",
		Title:  "TestArgmaxKeepdimsExampleSelectLastIndex",
