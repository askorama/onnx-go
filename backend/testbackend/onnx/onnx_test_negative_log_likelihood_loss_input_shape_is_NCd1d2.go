...
func init() {
	testbackend.Register("NegativeLogLikelihoodLoss", "TestNegativeLogLikelihoodLossInputShapeIsNCd1d2", NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2)
}
...
// NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2 version: 6.
func NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "NegativeLogLikelihoodLoss",
		Title:  "TestNegativeLogLikelihoodLossInputShapeIsNCd1d2",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217300)(name:"reduction" type:STRING s:"none" )
		   }
		   ,
		   },
