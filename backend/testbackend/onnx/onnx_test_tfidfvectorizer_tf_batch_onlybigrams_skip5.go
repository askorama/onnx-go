	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0000c68c0)(name:"max_gram_length" type:INT i:2 ),
		    (*ir.AttributeProto)(0xc0000c69a0)(name:"max_skip_count" type:INT i:5 ),
		    (*ir.AttributeProto)(0xc0000c6a80)(name:"min_gram_length" type:INT i:2 ),
		    (*ir.AttributeProto)(0xc0000c6b60)(name:"mode" type:STRING s:"TF" ),
		    (*ir.AttributeProto)(0xc0000c6c40)(name:"ngram_counts" type:INTS ints:0 ints:4 ),
		    (*ir.AttributeProto)(0xc0000c6d20)(name:"ngram_indexes" type:INTS ints:0 ints:1 ints:2 ints:3 ints:4 ints:5 ints:6 ),
		    (*ir.AttributeProto)(0xc0000c6e00)(name:"pool_int64s" type:INTS ints:2 ints:3 ints:5 ints:4 ints:5 ints:6 ints:7 ints:8 ints:6 ints:7 )
		   }
		   ,
		   },
