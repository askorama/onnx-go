...
func init() {
	testbackend.Register("Unsqueeze", "TestUnsqueezeAxis3", NewTestUnsqueezeAxis3)
}
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0001288c0)(name:"axes" type:INTS ints:3 )
		   }
		   ,
		   },
