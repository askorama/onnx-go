...
func init() {
	testbackend.Register("ReduceMin", "TestReduceMinNegativeAxesKeepdimsExample", NewTestReduceMinNegativeAxesKeepdimsExample)
}
...
// NewTestReduceMinNegativeAxesKeepdimsExample version: 6.
func NewTestReduceMinNegativeAxesKeepdimsExample() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ReduceMin",
		Title:  "TestReduceMinNegativeAxesKeepdimsExample",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000240100)(name:"axes" type:INTS ints:-2 ),
		    (*ir.AttributeProto)(0xc000240200)(name:"keepdims" type:INT i:1 )
		   }
		   ,
		   },
