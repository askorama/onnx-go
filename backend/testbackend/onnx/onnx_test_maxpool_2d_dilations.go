	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &pb.NodeProto{
		    ...
		    (*pb.AttributeProto)(0xc00014a200)(name:"dilations" type:INTS ints:2 ints:2 ),
		    (*pb.AttributeProto)(0xc00014a300)(name:"kernel_shape" type:INTS ints:2 ints:2 ),
		    (*pb.AttributeProto)(0xc00014a400)(name:"strides" type:INTS ints:1 ints:1 )
		   }
		   ,
		   },
