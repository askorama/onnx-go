...
func init() {
	testbackend.Register("ReduceProd", "TestReduceProdNegativeAxesKeepdimsExample", NewTestReduceProdNegativeAxesKeepdimsExample)
}
...
// NewTestReduceProdNegativeAxesKeepdimsExample version: 6.
func NewTestReduceProdNegativeAxesKeepdimsExample() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ReduceProd",
		Title:  "TestReduceProdNegativeAxesKeepdimsExample",
