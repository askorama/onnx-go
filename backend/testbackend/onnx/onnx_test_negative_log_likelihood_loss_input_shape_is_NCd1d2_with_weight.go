...
func init() {
	testbackend.Register("NegativeLogLikelihoodLoss", "TestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeight", NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeight)
}
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000216c00)(name:"reduction" type:STRING s:"none" )
		   }
		   ,
		   },
