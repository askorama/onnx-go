...
func init() {
	testbackend.Register("Unique", "TestUniqueSortedWithAxis", NewTestUniqueSortedWithAxis)
}
...
// NewTestUniqueSortedWithAxis version: 5.
func NewTestUniqueSortedWithAxis() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "Unique",
		Title:  "TestUniqueSortedWithAxis",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000128620)(name:"axis" type:INT ),
		    (*ir.AttributeProto)(0xc000128700)(name:"sorted" type:INT i:1 )
		   }
		   ,
		   },
		...
		*/
		...
		Input: []tensor.Tensor{
			...
			tensor.New(
				...
				tensor.WithBacking([]float32{1, 0, 0, 1, 0, 0, 2, 3, 4}),
			),
		},
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				...
				tensor.WithBacking([]float32{1, 0, 0, 2, 3, 4}),
			),
			...
			tensor.New(
				tensor.WithShape(3),
				tensor.WithBacking([]int64{0, 0, 1}),
			),
