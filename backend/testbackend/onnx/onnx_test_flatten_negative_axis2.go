...
func init() {
	testbackend.Register("Flatten", "TestFlattenNegativeAxis2", NewTestFlattenNegativeAxis2)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:        "test_flatten_negative_axis2",
        Initializer: nil,
        DocString:   "",
        Input:       {
            &ir.ValueInfoProto{
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0001762a0)(name:"axis" type:INT i:-2 )
		   }
		   ,
		   },
