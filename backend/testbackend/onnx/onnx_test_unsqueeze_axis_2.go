...
func init() {
	testbackend.Register("Unsqueeze", "TestUnsqueezeAxis2", NewTestUnsqueezeAxis2)
}
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc00039c1c0)(name:"axes" type:INTS ints:2 )
		   }
		   ,
		   },
