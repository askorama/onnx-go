...
func init() {
	testbackend.Register("ArgMax", "TestArgmaxKeepdimsRandomSelectLastIndex", NewTestArgmaxKeepdimsRandomSelectLastIndex)
}
...
// NewTestArgmaxKeepdimsRandomSelectLastIndex version: 6.
func NewTestArgmaxKeepdimsRandomSelectLastIndex() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ArgMax",
		Title:  "TestArgmaxKeepdimsRandomSelectLastIndex",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0005a0a80)(name:"axis" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc0005a0b60)(name:"keepdims" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc0005a0c40)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
