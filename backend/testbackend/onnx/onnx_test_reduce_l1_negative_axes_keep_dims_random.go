...
func init() {
	testbackend.Register("ReduceL1", "TestReduceL1NegativeAxesKeepDimsRandom", NewTestReduceL1NegativeAxesKeepDimsRandom)
}
...
// NewTestReduceL1NegativeAxesKeepDimsRandom version: 6.
func NewTestReduceL1NegativeAxesKeepDimsRandom() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "ReduceL1",
		Title:  "TestReduceL1NegativeAxesKeepDimsRandom",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0001761c0)(name:"axes" type:INTS ints:-1 ),
