	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &pb.NodeProto{
		    ...
		    (*pb.AttributeProto)(0xc00014a200)(name:"auto_pad" type:STRING s:"SAME_UPPER" ),
		    (*pb.AttributeProto)(0xc00014a300)(name:"kernel_shape" type:INTS ints:3 ints:3 ),
		    (*pb.AttributeProto)(0xc00014a400)(name:"strides" type:INTS ints:2 ints:2 )
		   }
		   ,
		   },
