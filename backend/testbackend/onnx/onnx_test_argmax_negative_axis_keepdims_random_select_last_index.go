...
func init() {
	testbackend.Register("ArgMax", "TestArgmaxNegativeAxisKeepdimsRandomSelectLastIndex", NewTestArgmaxNegativeAxisKeepdimsRandomSelectLastIndex)
}
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000217400)(name:"axis" type:INT i:-1 ),
		    (*ir.AttributeProto)(0xc000217500)(name:"keepdims" type:INT i:1 ),
		    (*ir.AttributeProto)(0xc000217600)(name:"select_last_index" type:INT i:1 )
		   }
		   ,
		   },
