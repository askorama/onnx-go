...
func init() {
	testbackend.Register("NegativeLogLikelihoodLoss", "TestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionMean", NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionMean)
}
...
// NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionMean version: 6.
func NewTestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionMean() *testbackend.TestCase {
	return &testbackend.TestCase{
		OpType: "NegativeLogLikelihoodLoss",
		Title:  "TestNegativeLogLikelihoodLossInputShapeIsNCd1d2WithWeightReductionMean",
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc0001e6100)(name:"reduction" type:STRING s:"mean" )
		   }
		   ,
		   },
		...
		*/
		...
		ExpectedOutput: []tensor.Tensor{
			...
			tensor.New(
				tensor.WithShape(1),
				tensor.WithBacking([]float32{-0.5416459}),
			),
		},
	}
}
