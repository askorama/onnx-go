	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &pb.NodeProto{
		    ...
		    (*pb.AttributeProto)(0xc00011c800)(name:"max_gram_length" type:INT i:2 ),
		    (*pb.AttributeProto)(0xc00011c900)(name:"max_skip_count" type:INT ),
		    (*pb.AttributeProto)(0xc00011ca00)(name:"min_gram_length" type:INT i:2 ),
		    (*pb.AttributeProto)(0xc00011cb00)(name:"mode" type:STRING s:"TF" ),
		    (*pb.AttributeProto)(0xc00011cc00)(name:"ngram_counts" type:INTS ints:0 ints:4 ),
		    (*pb.AttributeProto)(0xc00011cd00)(name:"ngram_indexes" type:INTS ints:0 ints:1 ints:2 ints:3 ints:4 ints:5 ints:6 ),
		    (*pb.AttributeProto)(0xc00011ce00)(name:"pool_int64s" type:INTS ints:2 ints:3 ints:5 ints:4 ints:5 ints:6 ints:7 ints:8 ints:6 ints:7 )
		   }
		   ,
		   },
