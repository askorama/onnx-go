...
func init() {
	testbackend.Register("Concat", "TestConcat3dAxisNegative3", NewTestConcat3dAxisNegative3)
}
...
&ir.ModelProto{
    ...
    Graph:           &ir.GraphProto{
        ...
        Name:        "test_concat_3d_axis_negative_3",
        Initializer: nil,
        DocString:   "",
        Input:       {
            &ir.ValueInfoProto{
	...
	return &testbackend.TestCase{
		...
		/*
		   ...
		   &ir.NodeProto{
		    ...
		    (*ir.AttributeProto)(0xc000176540)(name:"axis" type:INT i:-3 )
		   }
		   ,
		   },
